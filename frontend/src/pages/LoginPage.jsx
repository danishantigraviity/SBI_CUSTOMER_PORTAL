// ================================================================
//  LoginPage.jsx — Redesigned Customer & Admin Login Page
// ================================================================
      ...
      <div className="login-hero-container">
        ...
        <div className="login-hero-left">
          ...
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: 'rgba(0, 84, 166, 0.06)', border: '1px solid rgba(0, 84, 166, 0.12)', padding: '6px 12px', borderRadius: 20, width: 'fit-content' }}>
            ...
            <span style={{ fontSize: 10, fontWeight: 700, letterSpacing: 1.5, color: '#0054A6', textTransform: 'uppercase' }}>SECURE SaaS PORTAL</span>
          </div>
          ...
          <h1 className="premium-font-sora" style={{ fontSize: 38, fontWeight: 900, lineHeight: 1.15, letterSpacing: '-0.8px', color: '#0B1F45', margin: 0 }}>
            ...
            <span style={{ background: 'linear-gradient(135deg, #0054A6, #00A5EC)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>System</span>
          </h1>
          
          <p className="login-hero-desc" style={{ color: '#475569', fontSize: 13.5, lineHeight: 1.65, maxWidth: 330, marginTop: 8, marginBottom: 0 }}>
            Experience an enterprise-grade digital onboarding, instant KYC OCR processing, and powerful real-time eligibility evaluation in a single unified SaaS environment.
          </p>
        </div>

        {/* Column 2: Center Image Illustration Column */}
        ...
        {/* Column 3: Right side Glassmorphic Login Card */}
        <div className="login-hero-right">
          <div className="login-glass-card">

          {/* SBI Card Logo Emblem */}
          ...
          <div className="login-tab-container">
            <button 
              className={`login-tab-btn ${tab === 'customer' ? 'active' : ''}`}
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, marginTop: 14, fontSize: 11, color: '#64748B', fontWeight: 500 }}>
